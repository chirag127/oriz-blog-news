...
export const SITE_CONFIG: BlogConfig = {
  title: 'The Standpoint',
  description:
    'A news and commentary desk that sorts signal from noise — with practical guides to reading the news critically.',
  url: 'https://news-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-news') as `${string}/${string}`,
