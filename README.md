...
> Context over noise — explainers and analysis of the stories that matter.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-news?style=flat)](https://github.com/chirag127/oriz-blog-news/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-news)](https://github.com/chirag127/oriz-blog-news/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-news/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-news/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**News** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A news and current-affairs blog built for context — explainers and analysis over the churn of the daily feed.

- **Live site:** https://news-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-news
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-news/ — the canonical, always-current site is **https://news-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-news/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>news-blog.oriz.in"]
...
oriz-blog-news/
├── src/
│   ├── content/blog/       # the news explainers (MDX/Markdown)
